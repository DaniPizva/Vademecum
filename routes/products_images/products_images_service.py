...
def getAll() -> Tuple[List[ProductImage], Any]:
    try:
...
def createProductImage(data: Dict[str, Any]) -> Tuple[Optional[ProductImage], Any]:
    try:
        now = datetime.utcnow()
...
def updateProductImage(id: str, data: Dict[str, Any]) -> Tuple[Optional[ProductImage], Any]:
    try:
        collection = get_collection()
